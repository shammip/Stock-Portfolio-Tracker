...
- Pull requests and code reviews were new to most of our team so we discussed what they were used for and how to implement them. By the end of the project the process was natural to all of us and we all participated in code reviews.
...
- Additional features this API offered that were anticipated to be needed, but were not used were methods for more stringent user authentication. <br>
